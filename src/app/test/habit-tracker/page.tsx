...
const HabitTrackerApp = () => {
  ...
  const getMotivationQuote = () => {
    const completedCount = Object.values(dailyChecks).filter(v => v).length;
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
      <header className="bg-white/80 backdrop-blur-sm shadow-sm sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-emerald-600">Daily Routine</h1>
...
const HomePage = ({ routines, dailyChecks, onToggle, motivationQuote }) => {
  ...
  const completedCount = activeRoutines.filter(r => dailyChecks[r.id]).length;
        ...
        {isMorning ? (
          <div className="text-center">
            ...
            <p className="text-gray-600">
              ...
              {activeRoutines.length !== 1 ? "s" : ""}, let's do it 💪
            </p>
          </div>
        ) : (
          <div className="text-center">
            ...
            <p className="text-gray-600">
              You completed {completedCount} out of {activeRoutines.length}{" "}
              routines today
            </p>
          </div>
        )}
            ...
            {activeRoutines.map(routine => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500">{routine.timeOfDay}</p>
                </div>
              </div>
            ))}
          </div>
...
const TimelinePage = ({
    ...
    return (
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <h2 className="text-2xl font-bold text-gray-800">Weekly View</h2>
          <div className="flex gap-2">
            <button
              ...
              {activeRoutines.map(routine => (
                ...
                >
                  ...
                  {weekDays.map((date, i) => {
                    ...
                    const isRoutineDay = routine.repeat.includes(dayName);
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-gray-800">Daily Timeline</h2>
        <div className="flex gap-2">
          <button
