...
export default function LearningTimeline() {
  ...
  const [roadmap, setRoadmap] = useState([
    ...
    },
    {
      ...
      tasks: ["Ôn lại thao tác array, two-pointer", "Làm 3 bài Easy về Arrays"],
      resources: [
                ...
                <div className="p-5">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <div className="text-xs font-semibold text-gray-700">
                          {formatDate(calculateDate(item.day))}
                        </div>
                      </div>
                    </div>
                    <button
                  ...
                  <div className="mt-3 pt-3 border-t border-gray-200">
                    <div className="text-xs text-gray-500">
                      {item.tasks.length} nhiệm vụ • {item.resources.length} tài
                      nguyên
                    </div>
                  </div>
                </div>
                  ...
                  {roadmap.map((item, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-sm text-gray-600 max-w-md">
                        <div className="line-clamp-2">{item.goal}</div>
                      </td>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              {getCalendarDays().map((date, index) => {
                ...
                return (
                  <div
                    ...
                    onClick={() => lesson && setSelectedDay(lesson)}
                  >
                    {date && (
                      <>
            ...
            <div className="flex gap-6 mt-6 pt-6 border-t border-gray-200">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-600">Có bài học</span>
              </div>
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-sm opacity-90">
                      ...
                      {formatDate(calculateDate(selectedDay.day))}
                    </div>
